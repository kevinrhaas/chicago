...
RULES = {
    ...
    "a_sale_is_never_a_residence": {
        ...
        "statement": (
            ...
            "AND A ROW THE STRUCTURE LAYER CITES IS REFUSED HERE ALL THE SAME (T-1605). "
            "Two of these rows, ls0057 and ls0058, are named by `land_owner` blocks on 69 "
            "structure records as the entry on the ground a building stands on. That is a "
            "CITATION of the row and not a spend of its purchaser: the block states which "
            "tract contains a footprint and says of itself, in tools/resolve_land_tracts.py, "
            "that it does not claim the entryman lived there or ever stood on it. The unit "
            "here is a person, no person was written down, and "
            "research_spend_ledger.STRUCTURE_BLIND_KEYS carries the measurement that "
            "settled it."),
    },
}
