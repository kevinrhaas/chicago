...
/* 9. THE LABEL FILTER NAMES EXACTLY ONE LABEL, AND IT IS `hold` (T-1573).
 *
 ...
 * out of clock or budget or green, and merging it the moment GitHub calls it `clean` IS the resume,
 * done by machine for one REST call rather than by a whole run. It reads
