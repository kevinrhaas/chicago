...
Registered reading units: **23,697**, as of 2026-09-15. Unclassified: **0**. Asserted targets whose file no longer exists: **0**.
...
1. **No unit-level ledger entry reaches the structures layer.** 809 asserted units land on residents and households, 541 on businesses and 0 on structures. Closing it means a seat on the ground (T-1198) for a claim to be asserted ONTO.
