...
**Places.** 3,163 location rows reach a person; 465 of them reach the scene date. By claim kind: `business_location` 153, `home` 2,383, `later_home_address` 127, `later_workplace_address` 369, `workplace` 131.
