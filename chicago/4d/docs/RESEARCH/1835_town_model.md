...
| `people_the_layer_can_name` | **1,404** | The resident layer carries 1,404 people — 412 attested, 992 inferred, 1,581 reconstructed. A count of the layer, not of the town. |
...
- The authored spec's `population_working_range` is [3200, 3265]. This model's derived range for 1 July is [2,362, 3,265] — the same ceiling and a far lower floor. The roof programme is cut against the spec's range; T-1196 is where the two are reconciled.
