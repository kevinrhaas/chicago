...
- files that name one: **25**
- of those, **0** hold a reference a rename would falsify, **4** rename, **18** are re-derived by their own tool, **3** are frozen records of a past run
...
| --- | --- | ---: | ---: | ---: | ---: |
| `recon_1835_blk_randolph_market_a1_07` | `recon_1835_blk_randolph_market_d4_07` | 3 | 11 | 3 | 0 |
...
| `data/liberties.json` | 1 | compiled from docs/LIBERTIES.md by tools/compile_liberties.py |
...
| file | roofs | why |
| --- | ---: | --- |
| `docs/LIBERTIES.md` | 1 | append-only by its own rule; a liberty already taken is not rewritten, and the migration appends a new entry instead |
