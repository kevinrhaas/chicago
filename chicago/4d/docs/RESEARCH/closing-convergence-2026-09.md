...
|---|---:|---:|---:|
| households in `index.json` | 1258 | 1513 | +255 |
| household cards on disk | 1258 | 1513 | +255 |
| persons in `index.json` | 1288 | 2385 | +1097 |
| rows in the `merged` redirect table | 66 | 66 | 0 |
| redirects that do not arrive | 0 | 0 | 0 |
| persons graded `attested` | 410 | 412 | +2 |
| persons graded `inferred` | 875 | 993 | +118 |
| persons graded `reconstructed` | 3 | 980 | +977 |
| 1835 sidecar files | 391 | 421 | +30 |
| people in the 1835 people sidecar | 1288 | 3263 | +1975 |
...
| rows in the final resident audit | 1288 | 2385 | +1097 |
| published resident files in the mirror | 1336 | 2214 | +878 |
...
Acceptance 9 reads as a pair: 820 of 936 uncertain presences carry a `last_dated_appearance`, so the gap is 116.
