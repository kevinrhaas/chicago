...
moves Â· `renderers/web/js/changelog.js` Â· `site/4d/` Â· `docs/STATUS.md`.
...
`renderers/web/js/changelog.js` Â· `site/4d/` Â· `docs/`
...
(four new assertions) Â· `docs/evidence/r-w5a2-{before,after}.png` Â· `site/4d/**`.
...
`renderers/web/js/changelog.js` Â· `site/4d/` (publish mirror)
...
### Prairie research companion â€” 1904

The owner-requested `chicago/prairie_1904_v1` library supplies source-backed evidence
for T-0474â€“T-0477 and T-1250â€“T-1252. It keeps the supplied 1911 maps and three lost-house
corrections, measured Glessner material, named-building histories and independent
